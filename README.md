...
- [Request to join](how-to-join.md) the [DataScienceScotland](https://github.com/DataScienceScotland) organisation by [opening an issue](https://github.com/DataScienceScotland/welcome/issues/new/choose) in this repository.
