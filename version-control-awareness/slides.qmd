...
This is a valid form of version control - just not a very effective one!
...
[GitHub](https://github.com/) is a web interface for hosting version controlled code and can be used to:
...
Analysts in Scottish Government and departments should use the [Scottish Government Analysis GitHub organisation](https://github.com/ScotGovAnalysis) to store their repositories.
...
* [Use HTTPS to connect local repositories to GitHub](https://scotgovanalysis.github.io/welcome/using-https)
